#!/usr/bin/env python3
"""
Teste da API local na porta 8003
"""
import requests
import json
...
def test_api_local():
    ...
    print("🔍 Testando API local na porta 8003...")
    ...
    try:
        ...
        response = requests.post(
            'http://127.0.0.1:8003/leads/api/lead/',
            json=data_step1,
...
if __name__ == "__main__":
    success = test_api_local()
    if success:
        print("🎉 Teste da API local concluído com sucesso!")
    else:
        print("💥 Teste da API local falhou!")
